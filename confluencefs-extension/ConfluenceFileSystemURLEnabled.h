// ConfluenceFileSystemURLEnabled.h
...
// is registered dynamically in ConfluenceFileSystem+ServerURL.m via
// class_addProtocol, which runs at load time through __attribute__((constructor)).
